const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} CodeXus. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
const Exam_Result_Email_Template = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          <div class="header">Exam Result</div>
          <div class="content">
              <p>Hello {name},</p>
              <p>Thank you for participating in <strong>{examTitle}</strong>!</p>
              <table class="result-table">
                  <tr><th>Score</th><td>{score} / {maxScore}</td></tr>
              ...
              <p>We hope you found the exam valuable. For any queries, feel free to contact us.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} CodeXus. All rights reserved.</p>
          </div>
